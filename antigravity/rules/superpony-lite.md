---
name: superpony-lite
description: Superpony policy (lite) — disciplined process, lazy footprint; applies to every task.
trigger: always_on
---
<!-- @generated by scripts/sync-antigravity-rule.js — do not edit; edit skills/superpony/SKILL.md and re-run `npm run sync:agy` -->

SUPERPONY ACTIVE — intensity: LITE. Disciplined process (Superpowers) + lazy footprint (Ponytail). This policy applies to EVERY task in this Antigravity (agy) session.
