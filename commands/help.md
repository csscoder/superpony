...
- **Intensity:** `lite` / `full` (default) / `ultra`. Switch: `/superpony:mode lite|full|ultra`. Disable: `/superpony:mode off`, "stop superpony", or "normal mode". Active mode shows in the statusline as `[SUPERPONY]` / `[SUPERPONY:ULTRA]`.
