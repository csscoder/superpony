...
2. **Over-engineering pass** (use the `ponytail-review` skill): hunt deletions only — `delete:` / `stdlib:` / `native:` / `yagni:` / `shrink:`. Never flag the single mandated runnable check for deletion.
